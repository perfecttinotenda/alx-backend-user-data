...
class Base():
    ...
    def to_json(self, for_serialization: bool = False) -> dict:
        """ This will Convert the obj to a JSON dictionary
        """
        result = {}
    ...
    def load_from_file(cls):
        """ This will Load all objs from the file
        """
    ...
    def save_to_file(cls):
        """ This will Save all objs to file
        """
        s_class = cls.__name__
        file_path = ".db_{}.json".format(s_class)
        objs_json = {}
    ...
    def all(cls) -> Iterable[TypeVar('Base')]:
        """ This will Return all objs
        """
        return cls.search()

    @classmethod
    def get(cls, id: str) -> TypeVar('Base'):
        """ This will Return one obj by_ID
        """
        s_class = cls.__name__
    ...
    def search(cls, attributes: dict = {}) -> List[TypeVar('Base')]:
        """ This will Search all objs with matching attrs
        """
        s_class = cls.__name__
