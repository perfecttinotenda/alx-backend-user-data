...
class Base():
    ...
    def to_json(self, for_serialization: bool = False) -> dict:
        """
            This will convert the object a JSON dict.
        """
        result = {}
    ...
    def load_from_file(cls):
        """
            This will load all objs from file.
        """
    ...
    def save_to_file(cls):
        """
            Thia will save all objs to file.
        """
        s_class = cls.__name__
        file_path = ".db_{}.json".format(s_class)
        objs_json = {}
    ...
    def get(cls, id: str) -> TypeVar('Base'):
        """
            This will return one object by_ID.
        """
        s_class = cls.__name__
    ...
    def search(cls, attributes: dict = {}) -> List[TypeVar('Base')]:
        """
            This will search all objs with matching atts.
        """
        s_class = cls.__name__
        def _search(obj):
            if len(attributes) == 0:
